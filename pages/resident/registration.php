                            ...
                            <div class="container-fluid">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="txt_bdate" id="birthdate" class="form-control input-sm input-size" type="date" placeholder="Birthdate" onchange="calculateAge()"/>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">Age:</label>
                                        <input name="txt_age" id="age" class="form-control input-sm input-size" type="text" placeholder="Age" readonly/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="txt_faddress" class="form-control input-sm input-size" type="text" placeholder="Former Address"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="txt_upass" class="form-control input-sm input-size" type="password" placeholder="Password"/>
                                    </div>
